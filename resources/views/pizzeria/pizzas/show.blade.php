                    ...
                    {!!Form::open()->delete()->route('pizzas.destroy',[$pizza->id])!!}
                        <div class="row d-flex justify-content-center mt-3">                       
                            <div class="col-md-4 text-center">
                                <a href="{{route('pizzas.edit',[$pizza->id])}}" class="btn btn-md btn-info text-white col"> Editar </a>
                            </div>
                            <div class="col-md-4 text-center">
                                <button type="submit" value="" class="btn btn-md btn-danger col"> Deletar </button>
                            </div>
                            <div class="col-md-4 text-center">
                                <a href="{{route('pizzas.index')}}" class="btn btn-md btn-dark text-white col"> Voltar </a>
                            </div>                          
                        </div>  
                    {!!Form::close()!!}                       
                </div>
